...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 23, 2021 at 07:48 PM
...
CREATE TABLE IF NOT EXISTS `loginlog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17948 DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
(17944, 'tevye', 'no', 'no', '2021-03-19 21:21:16', 'Online', '127.0.0.1'),
(17945, 'tevye', 'no', 'no', '2021-03-19 21:21:25', 'Offline', '127.0.0.1'),
(17946, 'tevye', 'no', 'no', '2021-03-21 15:20:23', 'Online', '127.0.0.1'),
(17947, 'tevye', 'no', 'no', '2021-03-21 18:26:22', 'Offline', '127.0.0.1');
...
(1, 'tevye', '1830', '3fb0884ff9393b67bccb94c9bf7e95a8e30c7e85ca6f0b0e', 'no', 'no', '0.00', '0.00', 'B4', 40, 0, '2020-02-08 22:39:43', 'aktif', NULL, 40, 5, 0, 5, 'passive', 1, 0, '2020-02-09 01:39:43', 0, 15, 15);
COMMIT;
